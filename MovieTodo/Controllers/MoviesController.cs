...
namespace MovieTodo.Controllers
{
    public class MoviesController : Controller
    {
        private readonly MovieTodoContext _context;

        public MoviesController(MovieTodoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            // Count the amount of movies in the list.
            ViewData["MoviesCount"] = movies.Count; 

            // Count all the movies that are watched.
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,Watched")] Movie movie)
        {
            if (id != movie.ID)
            {
                return NotFound();
